 ...
 * one flat provider file); at most one provider plus the spec's artifact files are allowed companions;
 * any other path — including a retired candidate path the registry no longer accepts — makes it mixed-files.
 */
